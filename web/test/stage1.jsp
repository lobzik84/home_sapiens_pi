...
<h2>Тесты - этап 1</h2>
Проверяется raspberry в целом, получение даты, взаимодействие с arduino, датчики влажности, температуры, напряжения и температуры АКБ, сетевого напряжения, горючих газов, модем, камеры.<br>
Выполняется калибровка датчиков.
<br>
Проверьте адекватность параметров!
<br>
<br>
<%
