...
INSERT INTO `parameters` VALUES (1,'Internal Temperature','INTERNAL_TEMP','Температура в помещении','%2.1f','°C','DOUBLE',NULL),(2,'Internal Humidity','INTERNAL_HUMIDITY','Влажность воздуха','%2.1f','%','DOUBLE',NULL),(3,'Lumiosity','LUMIOSITY','Освещённость','%2.1f','lx','DOUBLE',NULL),(4,'Battery Voltage','VBAT_SENSOR','Напряжение АКБ','%2.1f','V','DOUBLE',0.011612447),(5,'AC Voltage','VAC_SENSOR','Напряжение в сети','%3.1f','V','DOUBLE',0.358064516),(6,'PIR Sensor','PIR_SENSOR','Датчик движения',NULL,NULL,'BOOLEAN',NULL),(7,'Gas Sensor','GAS_SENSOR','Датчик горючих газов',NULL,NULL,'BOOLEAN',NULL),(8,'Gas Sensor Signal','GAS_SENSOR_ANALOG','Сигнал с датчика газов',NULL,'V','DOUBLE',0.001075269),(9,'Battery Temperature','BATT_TEMP','Температура АКБ',NULL,'°C','DOUBLE',NULL),(10,'Modem RSSI','MODEM_RSSI','Уровень сигнала сотовой сети','%2.1f','dBm','DOUBLE',NULL),(11,'Outside Temperature','OUTSIDE_TEMP','Температура на улице','%2.1f','°C','DOUBLE',NULL),(12,'MIC Noise','MIC_NOISE','Датчик шума',NULL,NULL,'BOOLEAN',NULL),(13,'Lamp1','LAMP_1','Лампа 1',NULL,NULL,'BOOLEAN',NULL),(14,'Lamp2','LAMP_2','Лампа 2',NULL,NULL,'BOOLEAN',NULL),(15,'Socket','SOCKET','Розетка',NULL,NULL,'BOOLEAN',NULL),(16,'Charge Enabled','CHARGE_ENABLED','Включена зарядка батареи',NULL,NULL,'BOOLEAN',NULL),(17,'Rain','RAIN','Осадки','%2.1f','mm','DOUBLE',NULL),(18,'Clouds','CLOUDS','Облачность','%2.1f','%','DOUBLE',NULL),(19,'Battery Charge','BATT_CHARGE','Заряд батареи','%2d','%','INTEGER',NULL),(20,'Wet Sensor','WET_SENSOR','Датчик затопления',NULL,NULL,'BOOLEAN',NULL),(21,'Door Sensor','DOOR_SENSOR','Датчик открытия двери',NULL,NULL,'BOOLEAN',NULL),(22,'Night Time','NIGHTTIME','Ночное время',NULL,NULL,'BOOLEAN',NULL);
...
INSERT INTO `settings` VALUES (1,'BoxName','Прототип 23'),(2,'VACAlertMin','100'),(3,'VACAlertMax','250'),(4,'InTempAlertMin','18'),(5,'InTempAlertMax','40'),(6,'Lamp2PIRSensorScript','false'),(7,'Lamp1PIRSensorScript','false'),(8,'Lamp2DarkSensorScript','false'),(9,'Lamp1DarkSensorScript','true'),(10,'Socket1OnCommand433','10044428,200'),(11,'Socket1OffCommand433','10044420,200'),(12,'Lamp1OnCommand433','1222003,350'),(13,'Lamp1OffCommand433','1222004,350'),(14,'Lamp2OnCommand433','2159715,350'),(15,'Lamp2OffCommand433','2159716,350'),(16,'WetSensorAddress433','3526992'),(17,'DoorSensorAddress433','13088038'),(18,'SpeakerNotifications','true'),(19,'StatToEmailScript','false'),(20,'NotificationsEmail','labozin@molnet.ru'),(21,'ChargeAlertCritical','30'),(22,'ChargeAlertMinor','50'),(23,'VBatTempAlertMax','50'),(24,'SMSNotifications','true'),(25,'InHumAlertMax','85'),(26,'InHumAlertMin','15'),(27,'LumiosityDarkLevel','100');
...
-- Dump completed on 2016-11-28 16:31:37
